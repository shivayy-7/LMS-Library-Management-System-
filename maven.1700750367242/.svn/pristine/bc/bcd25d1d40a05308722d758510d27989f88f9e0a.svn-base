            ...
            <input type="hidden" name="subCategoryId" value="${subCategoryData.subCategoryId}" />
                <div class="row">
                 <div class="col-md-2">
                      ...
                      <div class="col-md-3">
		                <div class="form-group">
		                  <label class="required" for="">Sub-Category Name :</label>
		               ...
		               <div class="col-md-3">
		                <div class="form-group">
		                  <label for="">Sub-Category Description :</label>
		                  	<textarea class="form-control form-control-sm AlphaNumericOnly" id="subCategoryDescription" name="subCategoryDescription" maxlength="200">${subCategoryData.subCategoryDescription}</textarea>
		                </div>
		              </div>
		                ...
		                <div class="form-group dwnl-btn">
		                  <label class="smallInput required" for="">Sub-Category Image :</label>
		                  	<input type="file" class="form-control form-control-sm" id="subCategoryImageId" onchange=checkFileTypeExtAndSize(this,'2'); name="subCategoryImage" value="${subCategoryData.subCategoryImage}">
		              ...
		              <div class="col-md-2">
			              <div class="form-group">
			                  <label class="smallInput required" for="">Keywords :</label>
		             ...
		             <div class="col-md-12 mt-3" style="text-align:center;">
						...
						<a href="${contextPath}/mst/add-SubCategory" class="btn btn-danger btn-sm">Cancel</a>
				  	</div>
           	</div>
            </form>
            </div>
...
function saveForm(status){
	 if($("#categoryName").val() == 0){
	  ...
	  /* if($("#subCategoryDescription").val() == ""){
	   ...
	   if($("#subCategoryImageId").val() == ""){
		  bootbox.alert("Please Upload Sub-Category Image.");
		  return false;
	  }
	   if($("#chip-input").val() == ""){
		  bootbox.alert("Please Enter Some Keywords.");
		  return false;
	  } 
