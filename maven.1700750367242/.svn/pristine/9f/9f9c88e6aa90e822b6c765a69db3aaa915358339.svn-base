			...
			<div
				...
				<div class="ml-md-auto mb-4 py-2 py-md-0">
					<a href="${contextPath}"
						...
						class="btn btn-sm btn-border btn-blue btn-round mr-2">/Edit
						User</a>
				</div>
			</div>
		</div>
						...
						<div class="row">
							<div class="col-md-12">
								<form class="form-horizontal"
									action="${contextPath}/umt/user/update" method="POST"
									id="userForm">
												...
												<div class="form-group">
													...
													<div class="col-md-12">
														<input type="text" name="designation" id="designation"
															...
															value="${userDetails.designation}" required
															maxlength="150">
													</div>
												</div>
											</div>
									...
									<div class="card-footer text-center">
										<input type="button" class="btn btn-success btn-sm"
											...
											href="${contextPath}/umt/user/list" type="button"
