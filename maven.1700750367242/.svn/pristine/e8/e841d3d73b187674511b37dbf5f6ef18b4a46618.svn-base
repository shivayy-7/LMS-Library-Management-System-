function getTotalIncome_Quarter(finYearId) {
  $.ajax({
    type: "GET",
    url: contextPath + "/dashboard/getTotalIncome_Quarter",
    data: {
      finYearId: finYearId,
    },
    cache: false,
    ...
    success: function (response) {
      ...
      var chart = am4core.create("totalIncome_Quarter", am4charts.XYChart);
