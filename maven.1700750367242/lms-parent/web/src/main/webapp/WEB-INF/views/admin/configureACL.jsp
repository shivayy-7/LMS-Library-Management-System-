...
<script
	src="${contextPath}/assets/js/plugin/jquery_autocomplete/jquery.autocomplete.min.js"></script>
							...
							<%@ include file="/WEB-INF/views/message.jsp"%>
									...
									<div class="col-md-3">
										<div class="form-group">
											<label class="col-md-12 required" for="userName"><spring:message
													code="site.admin.user.id"></spring:message></label>
											<div class="col-md-12">
									...
									<div class="col-md-3">
										<div class="form-group">
											<label class="col-md-12 required" for="roleId"><spring:message
													code="site.admin.acl.role"></spring:message></label>
											<div class="col-md-12">
									...
									<div class="col-md-3">
										<div class="form-group">
											<label class="col-md-12 required" for="accessLevel"><spring:message
													code="site.admin.acl.level"></spring:message></label>
											<div class="col-md-12">
												<select class="form-control form-control-sm"
													id="accessLevelId" name="accessLevelId" disabled>
													<option value="" selected="selected">--SELECT--</option>
												</select>
											</div>
										</div>
					...
					<div class="card-body">
						<div class="col-md-12 table-responsive">
							...
							<div class="dt-header">
								...
								<div class="dt-header-right" style="float:right;">
									Search :<input type="text" class="dt-control" id="searchTerm"
										name="searchTerm" value="" />
								</div>
							</div>
							<!-- END Custom Dt Header -->
							<div id="pnl" style="margin-top:10px;">No data to display.</div>
