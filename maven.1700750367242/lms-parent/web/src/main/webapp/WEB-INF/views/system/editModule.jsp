						...
						<div class="row">
							...
							<div class="col-md-12">
								<form class="form-horizontal" method="POST"
									action="${contextPath}/system/setup/module/save" id="frmModule">
									...
									<div class="col-md-12">
										<div class="col-md-4">
											<div class="form-group">
												<label class="col-md-12 required" for="menuTextEN">Module
													Name (English)</label>
												<div class="col-md-12">
													<input type="text" id="menuTextEN" name="menuTextEN"
														onchange="validateCharacterOnly(this.value);"
														maxlength="70" value="${menu.menuTextEN}"
										...
										<div class="col-md-4">
											<div class="form-group">
												<label class="col-md-12 required" for="menuTextHI">Module
													Name (Hindi)</label>
												<div class="col-md-12">
													<input type="text" id="menuTextHI" name="menuTextHI"
														onchange="validateCharacterOnly(this.value);"
														maxlength="70" value="${menu.menuTextHI}"
														class="form-control" required>
												</div>
											</div>
										</div>
												...
												<div class="col-md-9">
													<div class="input-group">
														<input type="text" id="menuIcon" name="menuIcon" readonly
															value="${menu.menuIcon}" class="form-control" required>
										...
										<div class="col-md-3">
											<div class="form-group">
												<label class="col-md-12 required" for="isActive">Active
													Status</label>
												<div class="col-md-12">
													<input type="checkbox" id="isActive" name="isActive"
														${menu.isActive eq true ? 'checked' : ''}
														class="form-control" required style="height: 30px;">
												</div>
											</div>
										</div>
									</div>
									<div class="card-footer">
										<div class="col-sm-12 text-center mt-2">
											<input type="submit" class="btn btn-primary" value="Save"
												id="btnSubmit1" /> <a
												href="${contextPath}/system/setup/module"
