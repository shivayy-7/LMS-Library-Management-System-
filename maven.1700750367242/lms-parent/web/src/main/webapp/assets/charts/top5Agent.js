function findTop5AgentStatus(finYearId) {
  $.ajax({
    type: "GET",
    url: contextPath + "/dashboard/findTop5AgentStatus",
    data: {
      finYearId: finYearId,
    },
    cache: false,
    ...
    success: function (response) {
      ...
      var chart = am4core.create("top5Agent", am4charts.XYChart);
    ...
    },
    {
      ...
      chart.colors.list = [
        am4core.color("#1b9a80"),
        am4core.color("#f18b6d"),
        am4core.color("#a569cd"),
