var IncomeIndividualReportController = (function() {

	function IncomeIndividualReportController(token) {
		this.csrfToken = token;
		this.schemeId = 0;
		this.payload = {};
	}

	IncomeIndividualReportController.prototype.render = function(fromDate, toDate, comparePrevYear,
		...
		$("#pnlReport").fancytree({
			source: {
				url: window.contextPath + "/reports/getReportDataForIndividual",
				data : me.payload,
				dataType: "json"
			},
			extensions: ["table"],
	...
	return IncomeIndividualReportController;
