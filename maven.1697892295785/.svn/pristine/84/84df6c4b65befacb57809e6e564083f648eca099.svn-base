function paymentComparisionQuarterWise(finYearId) {
  $.ajax({
    type: "GET",
    url: contextPath + "/dashboard/paymentComparisionQuarterWise",
    data: {
      finYearId: finYearId,
    },
    cache: false,
    ...
    success: function (response) {
      ...
      var chart = am4core.create("chartPC_Quarter", am4charts.XYChart);
