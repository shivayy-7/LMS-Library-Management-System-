			...
			<div
				...
				<div>
					<h2 class="text-blue pb-2 fw-bold">
						<spring:message code="site.system.module.add" />
					</h2>
							...
							<div class="col-md-12">
								<form class="form-horizontal" method="POST"
									...
									<div class="col-md-12">
											...
											<div class="form-group">
												...
												<div class="col-md-12">
													<input type="text" id="menuTextEN" name="menuTextEN"
														...
														value="${menu.menuTextEN}" maxlength="70"
											...
											<div class="form-group">
												...
												<div class="col-md-12">
													<input type="text" id="menuTextHI" name="menuTextHI"
														onchange="validateCharacterOnly(this.value);"
														value="${menu.menuTextHI}" maxlength="70"
														class="form-control" required>
												</div>
											</div>
										</div>
											...
											<div class="form-group">
												...
												<div class="col-md-12">
													<input type="number" id="displayOrder" name="displayOrder"
														min="1" value="${menu.displayOrder}" class="form-control"
										...
										<div class="col-md-3">
											<div class="form-group">
												<label class="col-md-12 required1" for="isActive">Active
													Status</label>
												<div class="col-md-12">
