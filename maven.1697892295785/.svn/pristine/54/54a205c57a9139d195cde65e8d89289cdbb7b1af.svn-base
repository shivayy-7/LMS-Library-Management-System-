function paymentComparisionMonthWise(finYearId) {
  $.ajax({
    type: "GET",
    url: contextPath + "/dashboard/paymentComparisionMonthWise",
    data: {
      finYearId: finYearId,
    },
    cache: false,
    ...
    success: function (response) {
      ...
      var chart = am4core.create("chartPC_Month", am4charts.XYChart);
