							...
							<div class="col-md-12">
								<form class="form-horizontal" method="POST"
									...
									<div class="col-md-12">
										...
										<div class="col-md-4">
											<div class="form-group">
												<label class="col-md-12 required1" for="menuIcon">Menu
													Icon</label>
												<div class="col-md-9">
											...
											<div class="form-group">
												...
												<div class="col-md-12">
													<input type="number" id="displayOrder" name="displayOrder"
														min="1" maxlength="10" value="${menu.displayOrder}"
														class="form-control" required>
												</div>
											</div>
										</div>
										...
										<div class="col-md-12">
											<div class="form-group">
												<label class="col-md-12 required1" for="menuURL">Menu
													URL</label>
												<div class="col-md-12">
													<input type="text" id="menuURL" name="menuURL"
														value="${menu.menuURL}" maxlength="150"
														class="form-control"
														${menu.isParent eq true ? '' : 'readonly'}>
												</div>
											</div>
										</div>
										<div class="card-footer">
											<div class="col-sm-12 text-center mt-2">
												<input type="submit" class="btn btn-primary" value="Save"
													id="btnSubmit1" /> <a
													href="${contextPath}/system/setup/menu/list"
